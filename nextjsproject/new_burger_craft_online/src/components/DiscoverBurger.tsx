...
import Images from '@/assets/images/discoverburger.png'
import React, {useEffect} from 'react';

const DiscoverBurger:React.FC = () => {
    ...
    return (<div className={'  my-auto'} >
        ...
        <div className="flex flex-col lg:flex-row items-center justify-center p-2 m-0 ">
            <div className="text-center md:text-left py-6 max-w-[540px]">
                <h1 className="text-2xl font-bold   md:text-4xl">Make Your Own Burger</h1>
                <p className="mt-4 text-gray-600 text-base text-lg   md:text-xl lg:text-2xl xl:text-3xl">
