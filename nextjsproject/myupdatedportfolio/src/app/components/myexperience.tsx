  ...
  return (
    <Paper sx={experienceStyle}>
      <Container maxWidth="md" data-aos="fade-right">
        <Typography variant="h4" gutterBottom style={titleStyle as React.CSSProperties}>
        ...
        <section>
          <div className="experience-item">
            ...
            <Typography variant={"body1"} style={{ marginBottom: ".6rem" }}>
              <strong>Description:</strong> As a self-employed front-end
              developer, I worked on a variety of web development projects,
              focusing on creating responsive and visually appealing websites. I
